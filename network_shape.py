...
# 
# net = Network([784, 16, 10], regularization = 0.1)  # activation_func = relu, activation_derivative = relu_derivative)
# n_epochs = 50 #30
...
shape_net = Network([16,6,4], regularization=0.00)   # 16 is number of inputs, 4 is the number of outputs
