...
#
#net = Network([784, 16, 10], regularization = 0.0)  # activation_func = relu, activation_derivative = relu_derivative)
#n_epochs = 2000 #30
...
n_epochs_shape = 300
shape_net.SGD(s_training_data, n_epochs_shape, 10, 0, s_test_data)
